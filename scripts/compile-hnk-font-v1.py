...
cmap=json.loads((ROOT/'font/HNK_FONT_CMAP_V1.json').read_text())
...
report={'family':'HNK Visual Canon V2','version':'1.0.0','glyphMappings':len(cmapMap),'files':{}}
...
(OUT/'HNK_FONT_BUILD_REPORT_V1.json').write_text(json.dumps(report,indent=2)+'\n')

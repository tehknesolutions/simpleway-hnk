# HNK Phonotactic Profile V2 — Governed Current Profile

**Profile ID:** `SWHNK-HNK-PHONOTACTIC-PROFILE-V2`  
**State:** `CURRENT_GOVERNED_PROFILE`  
**Approved by:** `SWHNK-HNK-B6-PHONOTACTIC-PROFILE-V2-HUMAN-GATE-V1`  
**Provenance:** Sprint A audit + approved Sprint B gates B1–B6  
...
- `HNK_PHONOTACTIC_PROFILE_V1.md` is `HISTORICAL_PRIOR`;
...
B6 approval governs the **profile itself**. It does not:

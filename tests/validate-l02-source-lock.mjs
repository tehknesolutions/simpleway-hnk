...
assert.equal(manifest.status,'SOURCE_LOCK_AUDITED_PEDAGOGY_HOLD');
...
console.log('PASS SWHNK-L02-CHOKHMAH-SOURCE-LOCK-V1');
console.log('L02 Source Lock: 11 recovered lexemes, 0 phrases, 5 proxy-gap vocabulary slots; pedagogy remains HOLD until semantic curriculum targets are explicitly governed.');

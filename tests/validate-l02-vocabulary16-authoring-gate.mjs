...
assert.equal(gate.checks.mapped_slots,16);
assert.equal(gate.checks.authored_before_gate,0);
...
console.log('PASS SWHNK-L02-VOCABULARY16-AUTHORING-GATE-PENDING-V1');
